...
exports.addVedio = async(req,res)=>{
    try{
        const addVedio = await new vedioModal({...req.body,
            createdBy: mongoose.Types.ObjectId(req.user_id)
        })
        const SaveVedio = await addVedio.save()
        successResponse(res,statusCode.msg_save_code,generalSuccessMessages.UserCreatedSuccessfully,SaveVedio)
...
exports.fetchOne = async(req,res)=>{
    try{
        ...
        successResponse(res,statusCode.msg_save_code,generalSuccessMessages.fetch_One_Record,fetchVedio)
...
exports.updateVedio = async(req,res)=>{
    try{
        const updateVedio = await vedioModal.findByIdAndUpdate(req.params.id, req.body);
        successResponse(res,statusCode.msg_save_code,generalSuccessMessages.msg_update_text,updateVedio)
